...
//testing push
public class ActivityRecommendations extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.recommendations);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_achievements){
            ...
            Intent intent = new Intent(this, ActivityRecommendations.class);
            startActivity(intent);
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.recommendations);
