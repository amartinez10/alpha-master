...
//testing push
public class ActivityReminders extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.reminders);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.reminders);
