...
//testing push
public class ActivityDiet extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.diet);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_achievements){
            ...
            Intent intent = new Intent(this, ActivityDiet.class);
            startActivity(intent);
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.diet);
