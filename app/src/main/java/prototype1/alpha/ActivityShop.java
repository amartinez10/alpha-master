...
//testing push
public class ActivityShop extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.shop);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.shop);
