...
public class ActivityFriends extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.friends);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.friends);
