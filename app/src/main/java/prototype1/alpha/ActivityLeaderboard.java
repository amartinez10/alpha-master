...
//testing push
public class ActivityLeaderboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.leaderboard);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.leaderboard);
